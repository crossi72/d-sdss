...
#Region " Private methods "
	...
	Private Sub Calculate()
		...
		Me.myMathWrapper.WaitAndDiscardAnswer("tpbx=" & NumberAsString(Me.tpbx))
		Me.myMathWrapper.WaitAndDiscardAnswer("tpmz=0.30")
